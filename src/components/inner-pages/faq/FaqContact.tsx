...
const faq_contact_data: DataType[] = [
  {
    ...
    contact_1: (
      <>
        Mobile : <a href="tel:+919096207767">+91 90962 07767</a>
      </>
    ),
    contact_2: (
      <>
  ...
  },
  {
    ...
    data_wow_delay: ".5s",
    title: "Mail Address",
    contact_1: <>mindsetmanifestationacademy@gmail.com</>,
    contact_2: <></>,
  },
  {
    id: 3,
    ...
    contact_1: (
      <>
        Mindset Manifestation Academy C/o Suyash Sales and Services Itke Corner
        Parli - Vaijanath-431515
      </>
    ),
    contact_2: <></>,
  },
