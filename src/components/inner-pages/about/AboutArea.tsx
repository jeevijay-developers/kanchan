...
const about_content: ContentType = {
  sub_title: "About Dr. Kanchan Kabra",
  title: "Empowering Minds, Transforming Lives",
  desc_1: (
    <>
      Dr. Kanchan Kabra is a renowned mindset coach, speaker, and trainer who has
  ...
  desc_2: (
    <>
      ...
      seeking personal growth, Dr. Kanchan Kabra’s guidance can help you break
