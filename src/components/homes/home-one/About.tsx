...
const about_data: DataType = {
  ...
  desc: "Whether you’re striving for personal growth, professional success, or a balanced life, Dr. Kanchan kabra is here to guide you with proven techniques and strategies. Through *seminars, webinars, and personalized coaching*, she has transformed the lives of thousands.",
  about_list: [
              ...
              <div className="col-xl-6 col-lg-8 mt-5 mt-xl-0">
                <div className="about-content">
                  ...
                  <p className="mt-4 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                    ...
                    professional success, or a balanced life, Dr. Kanchan Kabra
