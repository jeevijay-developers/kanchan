...
const testi_data: DataType[] = [
  ...
  },
  {
    ...
    desc_2: (
      <>
        That is when I had a talk Dr. Kanchan Kabra. I still remember that 45
  ...
  },
  {
    ...
    desc_1: (
      <>
        ...
        time I got to know about dr. kanchan kabra.
      </>
    ),
    desc_2: (
      <>
  ...
  },
  {
    ...
    desc_2: (
      <>
        {" "}
        Coach Dr. Kanchan kabra...... Her mindset techniques helped me understand
      ...
      <div className="container">
        <div className="section-title text-center">
          ...
          <h2 className="wow fadeInUp" data-wow-delay=".3s">
            public feedback about Dr. Kanchan Kabra
          </h2>
        </div>
        <Swiper
          {...setting}
